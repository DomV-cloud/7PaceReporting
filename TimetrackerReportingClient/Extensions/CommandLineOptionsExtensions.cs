...
{
    public static CommandLineOptions ParseCmdCommands(this CommandLineOptions commandLineOptions, string[] args) {
        Parser
    ...
    public static CommandLineOptions InitCLI(this CommandLineOptions commandLineOptions, string[] args) {
